...
OWNER_ID = int(getenv("OWNER_ID", 7894534724))
OWNER_USERNAME = getenv("OWNER_USERNAME", "螿 Sᴜɴɢ•Jɪɴᴡᴏᴏ ࿐")
BOT_USERNAME = getenv("BOT_USERNAME", "RiasXmusic_bot")
BOT_NAME = getenv("BOT_NAME", "˹ʀɪᴀꜱ ˣ ᴍᴜꜱɪᴄ˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "Rias_Assistant")
...
# ───── Git & Updates ───── #
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/mssamad07/hinataXmusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN")

# ───── Support & Community ───── #
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Cinema_Hub_ABS")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ABS_Discussionn")
...
START_VIDS = [
    "https://graph.org/file/4423472edd1595c049500-289eb2cbf97d0bd6d4.jpg",
    "https://graph.org/file/23e0644e2ce583f939983-2ebae6f6d545c6f890.jpg",
    "https://graph.org/file/893dc5fd32c2bf178b4ba-33c8bb890c467d598b.jpg"
]
